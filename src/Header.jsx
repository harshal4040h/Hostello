...
export default function Home() {
  return (
    <div className=' rounded-r-xl bg-gray-900'>
      ...
      <div className='flex mt-4 hover:cursor-pointer'>
        ...
        <div>
          <h1 className='text-gray-400 text-xl font-bold ml-2 '>Hostel Managment</h1>
        </div>
      </div>
      ...
      <div className='flex mt-10 hover:cursor-pointer hover:border-l-[3px] border-white  hover:text-white hover:bg-gray-700 hover:rounded-lg'>
        ...
        <div>
          <h1 className='text-gray-400 text-xl font-bold ml-2 ' ><Link to={"/"}>Home</Link></h1>
        </div>
      </div>
      ...
      <div className='flex mt-7 absolute bottom-0 mb-4'>
        <div className=''>
        ...
        <div>
          <h1 className='text-white text-xl font-bold ml-2 '></h1>
        </div>
      </div>
